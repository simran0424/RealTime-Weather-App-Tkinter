...
def tell_weather() : 
	...
	api_key = "db7218a1e0752f164b9a1f7368802abd"
...
if __name__ == "__main__" :  
	...
	label1 = Label(root, text = "City name : ", fg = 'black', bg = 'dark gray') 
	
	# Create a City name : label 
	label2 = Label(root, text = "Temperature :", fg = 'black', bg = 'dark gray') 

	# Create a atm pressure : label 
	label3 = Label(root, text = "atm pressure :", fg = 'black', bg = 'dark gray') 

	# Create a humidity : label 
	label4 = Label(root, text = "humidity :", fg = 'black', bg = 'dark gray') 

	# Create a description :label 
	label5 = Label(root, text = "description :", fg = 'black', bg = 'dark gray') 
